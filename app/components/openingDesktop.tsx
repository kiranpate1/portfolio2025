...
const OpeningDesktop = ({ sectionProgress }: props) => {
  ...
  return (
    <div className="window absolute flex w-full">
      ...
      <div
        className="absolute z-100 left-0 -bottom-8 w-full h-[10vh] bg-[var(--shade-900)]"
        style={{
          opacity: sectionProgress ? 1 - sectionProgress : 1,
